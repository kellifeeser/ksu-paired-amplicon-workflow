...
-   Residualized regressions and full models (effect of fungal state on bacterial dissimilarity after controlling for i) fungal dissimilarity, ii) fungal state dispersion, iii) bacterial regional species pool, and iv) host)

    -   <a href="residualizedregressions.html" target="_blank">Storyline 3: Residualized regressions</a> (last updated 04 Feb 2026)
