...
rmarkdown::render("code/AlphaBetaGamma_BySite.Rmd", output_file="/Users/L347123/Desktop/ksu-paired-amplicon-workflow/docs/github_AlphaBetaGamma_BySite")
  # needed to go into PAM_clusters
...
#render nestedness_looped_params.Rmd
rmarkdown::render("code/nestedness_looped_params.Rmd", output_file="/Users/L347123/Desktop/ksu-paired-amplicon-workflow/docs/github_nestedness_looped_params_bacteria")
...
#render F1_vs_nonF1_v2
rmarkdown::render("code/F1_vs_nonF1_v2.Rmd", output_file="/Users/L347123/Desktop/ksu-paired-amplicon-workflow/docs/github_F1_vs_nonF1_v2")

#render MRM_SEM_Landspace_Bacteria
rmarkdown::render("code/MRM_SEM_Landspace_Bacteria.Rmd", output_file="/Users/L347123/Desktop/ksu-paired-amplicon-workflow/docs/github_MRM_SEM_Landspace_Bacteria")

#render MRM_SEM_Landspace_Fungi
rmarkdown::render("code/MRM_SEM_Landspace_Fungi.Rmd", output_file="/Users/L347123/Desktop/ksu-paired-amplicon-workflow/docs/github_MRM_SEM_Landspace_Fungi")
```

On this GitHub Pages site, you can find:

1.  [Comparison to subset of Rudgers 2021 results (with bacteria)](github_Comparison_Rudgers2021.html)
2.  [Darksidea stats for Aaron](github_darksidea.html)
3.  [Distribution of Darksidea and Monosporascus](DistributionOfDarksideaMono.html)
    -   also [Distribution and diversity of *Darksidea* and *Monosporascus* sp. with variable input data]
4.  [Manuscript story elements]\
...
#### Miscellaneous Links {.unnumbered}

##### <a href="github_darksidea.html" target="_blank">Darksidea stats for Aaron</a> {.unnumbered}

##### <a href="github_Comparison_Rudgers2021.html" target="_blank">Comparison to subset of Rudgers 2021 results (with bacteria) </a> {.unnumbered}

Previous manuscript: Rudgers, J.A., Fox, S., Porras‐Alfaro, A., Herrera, J., Reazin, C., Kent, D.R., Souza, L., Chung, Y.A., & Jumpponen, A. (2022). Biogeography of root‐associated fungi in foundation grasses of North American plains. Journal of Biogeography, 49(1), 22-37. doi/10.1111/jbi.14260\
...
##### <a href="DistributionOfDarksideaMono.html" target="_blank">Distribution of *Darksidea* and *Monosporascus*</a> {.unnumbered}
...
-   <a href="github_darksidea_allSamplesincEDGE.html" target="_blank">Full untrimmed input data: [all samples]{.underline}; EDGE samples included, samples with missing pairs included (last updated 30 April 2025)</a>

    -   changes: increased n of samples from 484 to 654, n SEV samples increased from 10 to 53, *Monosporascus* detected at the SEV (1 OTU found in 2.7% of *Black grama* SEV soils with mean relative abundance of 1.9%, when present)
...
## Manuscript story elements {.unnumbered}

\

-   <a href="1_KSU_16S_ITS_otu_processing_kf_EXAMPLE.html" target="_blank">Raw OTU table processing for 16S and ITS</a> (last updated 11 July 2024)
...
-   <a href="github_AlphaBetaGamma_BySite.html" target="_blank">Alpha- Beta- Gamma- diversity by site</a> (last updated 24 Mar 2025)

-   <a href="github_PAM_Clusters.html" target="_blank">Subassemblage (PAM) Clustering of Bacteria and Fungi</a> (last updated 31 May 2025)

    -   has *by-subassemblage* stats for metadata, 𝛼-, 𝛽-, and 𝛾-div, beta dispersion (homogeneity vs. heterogeneity), and taxonomy
...
-   Spatial Origins and Cross-Kingdom Congruence in Bacterial and Fungal Communities

    -   <a href="github_F1_vs_nonF1.html" target="_blank">Contrasting fungal F1 subassemblage vs. non-F1 subassemblages and associated bacterial communities</a> (last updated 23 April 2025 - see <a href="github_F1_vs_nonF1_v2.html" target="_blank">version 2</a>)

-   MRM Results

    -   <a href="github_MRM_SEM_Landspace_Bacteria.html" target="_blank">Bacteria - Landscape-scale</a> (last updated 20 May 2025)
    -   <a href="github_MRM_SEM_Landspace_Fungi.html" target="_blank">Fungi - Landscape-scale</a> (last updated 18 July 2025)

\

-   Residualized regressions and full models (effect of fungal state on bacterial dissimilarity after controlling for i) fungal dissimilarity, ii) fungal state dispersion, iii) bacterial regional species pool, and iv) host). <a href="residualizedregressions_untrimmed2.html" target="_blank">(untrimmed)</a>

    -   <a href="residualizedregressions_clean.html" target="_blank">Storyline 3: Residualized regressions</a> (last updated 04 Feb 2026)
