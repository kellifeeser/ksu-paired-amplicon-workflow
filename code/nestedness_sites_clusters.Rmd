...
FIG_PATH="../docs/github_nestedness_sites_clusters_figures/"
CACHE_PATH="../docs/github_nestedness_sites_clusters_cache/"
...
vard_intpred <- c("Bac_sor_clusters","Fun_sor_clusters","Fun_sor_clus2",
                  "nsamples_per_Site",
...
vard_climate <- c("GDD3yr","GDD30yr","ppt3yr","ppt30yr")
vard_climate_m.std <- c("GDD3yr_m.std","GDD30yr_m.std","ppt3yr_m.std","ppt30yr_m.std")

vard_edaphic <- c("SOM", "soil_moisture","GWC", "perc_moisture", "pH","phos","nitrate","ammonium")

vard_edaphic_m.std <- c("SOM_m.std", "soil_moisture_m.std","GWC_m.std", "perc_moisture_m.std", "pH_m.std","phos_m.std","nitrate_m.std","ammonium_m.std")

vard_plant <- c("avg_SRL","avg_SLA","herbivory_perc")

vard_plant_m.std <- c("avg_SRL_m.std","avg_SLA_m.std","herbivory_perc_m.std")


vard_all <- c("Site", "Grass", "Site_Grass", "Grassland", "Latitude", "Longitude", "Elevation_m", "GDD3yr", "GDD30yr", "ppt3yr", "ppt30yr", "SOM", "soil_moisture", "GWC", "perc_moisture", "pH", "phos", "nitrate", "ammonium", "avg_SRL", "avg_SLA", "herbivory_perc", "GDD3yr_m.std", "GDD30yr_m.std", "ppt3yr_m.std", "ppt30yr_m.std", "SOM_m.std", "soil_moisture_m.std", "GWC_m.std", "perc_moisture_m.std", "pH_m.std", "phos_m.std", "nitrate_m.std", "ammonium_m.std", "avg_SRL_m.std", "avg_SLA_m.std", "herbivory_perc_m.std", "Bac_sor_clusters", "Fun_sor_clusters", "Fun_sor_clus2", "nsamples_per_Site", "nsamples_perBac_sor_clusters", "nsamples_perFun_sor_clusters", "ngrass_persite", "ngrass_perBac_sor_clusters", "ngrass_perFun_sor_clusters", "Bac_gamma_Site", "Fun_gamma_Site")
...
decay.Bac_all_geodist.exp.sor<-decay.model(y=betapart_results[["Bac"]][["all"]][["pairwise"]][["beta.sor"]], x=env_dist_matrices[["all"]][["geodist_Bac"]], y.type="dissim", model.type="exp",perm = 1000)
# $aic -264040.7
# $pseudo.r.squared 0.1566976

decay.Bac_all_geodist.exp.sim<-decay.model(y=betapart_results[["Bac"]][["all"]][["pairwise"]][["beta.sim"]], x=env_dist_matrices[["all"]][["geodist_Bac"]], y.type="dissim", model.type="exp",perm = 1000)
# $aic -241756
# $pseudo.r.squared 0.1260104

decay.Bac_all_geodist.exp.sne<-decay.model(y=betapart_results[["Bac"]][["all"]][["pairwise"]][["beta.sne"]], x=env_dist_matrices[["all"]][["geodist_Bac"]], y.type="dissim", model.type="exp",perm = 1000)
# $aic -264040.7
# $pseudo.r.squared 0.1566976 0.0003461677


decay.Fun_all_geodist.exp.sor<-decay.model(y=betapart_results[["Fun"]][["all"]][["pairwise"]][["beta.sor"]], x=env_dist_matrices[["all"]][["geodist_Fun"]], y.type="dissim", model.type="exp",perm = 1000,perm = 1000)
# $aic -130861.6
# $pseudo.r.squared 0.0211216

decay.Fun_all_geodist.exp.sim<-decay.model(y=betapart_results[["Fun"]][["all"]][["pairwise"]][["beta.sim"]], x=env_dist_matrices[["all"]][["geodist_Fun"]], y.type="dissim", model.type="exp",perm = 1000)
# $aic -117996.9
# $pseudo.r.squared 0.01433185

decay.Fun_all_geodist.exp.sne<-decay.model(y=betapart_results[["Fun"]][["all"]][["pairwise"]][["beta.sne"]], x=env_dist_matrices[["all"]][["geodist_Fun"]], y.type="dissim", model.type="exp",perm = 1000)
# $aic -442536.6
...
zdepDDBF_All_sor<-zdep(decay.Bac_all_geodist.exp.sor, decay.Fun_all_geodist.exp.sor, resamples=500, st.val = c(1, 0))

zdepDDBF_All_sim<-zdep(decay.Bac_all_geodist.exp.sim, decay.Fun_all_geodist.exp.sim, resamples=500, st.val = c(1, 0))

zdepDDBF_All_sne<-zdep(decay.Bac_all_geodist.exp.sne, decay.Fun_all_geodist.exp.sne, resamples=500, st.val = c(1, 0))
...
plot.decay.pretty(decay.Bac_all_geodist.exp.sor, col="#006e90", main="Bacteria\n",
           lty=1,lwd=5,cex.main=1.1,
           xlim = c(0,1600),ylim = c(0,1),col.line="#004E66",
           xaxp = c(0,1500,3),
           ylab="Total\nDissimilarity",xlab="")
# text(2, 0.1, paste0("a = ", round(decay.Bac_all_geodist.exp.sor$first.parameter,3),", b = ",formatC(decay.Bac_all_geodist.exp.sor$second.parameter,digits=3, format="e")),adj = c(0,0), cex=0.8)
mtext(paste0("βsor ~ S: pseudo-R2 = ", round(decay.Bac_all_geodist.exp.sor$pseudo.r.squared,3),
             ", p-value = ",round(decay.Bac_all_geodist.exp.sor$p.value,3)), side = 3, line = 0.25, outer = F,adj = c(0,0), cex=0.7) # side 1=bottom, 2=left, 3=top, 4=right

plot.decay.pretty(decay.Fun_all_geodist.exp.sor, col="#f18f01", add=F, main="Fungi\n", 
           xlim = c(0,1600),ylim = c(0,1),las=1, lty=1,lwd=5,cex.main=1.1,
           col.line="#B76E01",xaxp = c(0,1500,3),
           ylab="",xlab="")
mtext(paste0("βsor ~ S: pseudo-R2 = ", round(decay.Fun_all_geodist.exp.sor$pseudo.r.squared,3),
             ", p-value = ",round(decay.Bac_all_geodist.exp.sor$p.value,3)), side = 3, line = 0.25, outer = F,adj = c(0,0), cex=0.7) # side 1=bottom, 2=left, 3=top, 4=right
mtext("\nDistance between Communities (in km)", side = 1, line = 1, outer = TRUE) # side 1=bottom, 2=left, 3=top, 4=right

# turnover
plot.decay.pretty(decay.Bac_all_geodist.exp.sim, col="#006e90", 
           lty=1,lwd=5,cex.main=1,
           xlim = c(0,1600),ylim = c(0,1),col.line="#004E66",
           xaxp = c(0,1500,3),
           ylab="Turnover-Resultant\nDissim.",xlab="")
mtext(paste0("βsim ~ S: pseudo-R2 = ", round(decay.Bac_all_geodist.exp.sim$pseudo.r.squared,3),
             ", p-value = ",round(decay.Bac_all_geodist.exp.sim$p.value,3)), side = 3, line = 0.5, outer = F,adj = c(0,0), cex=0.7) # side 1=bottom, 2=left, 3=top, 4=right

plot.decay.pretty(decay.Fun_all_geodist.exp.sim, col="#f18f01", add=F, 
           xlim = c(0,1600),ylim = c(0,1),las=1, lty=1,lwd=5,
           col.line="#B76E01",xaxp = c(0,1500,3),
           ylab="",xlab="")
mtext(paste0("βsim ~ S: pseudo-R2 = ", round(decay.Fun_all_geodist.exp.sim$pseudo.r.squared,3),
             ", p-value = ",round(decay.Fun_all_geodist.exp.sim$p.value,3)), side = 3, line = 0.5, outer = F,adj = c(0,0), cex=0.7) # side 1=bottom, 2=left, 3=top, 4=right


#nestedness
plot.decay.pretty(decay.Bac_all_geodist.exp.sne, col="#006e90", 
           lty=1,lwd=5,cex.main=1,
           xlim = c(0,1600),ylim = c(0,1),col.line="#004E66",
           xaxp = c(0,1500,3),
           ylab="Nestedness-Resultant\nDissim.",xlab="")
mtext(paste0("βsne ~ S: pseudo-R2 = ", round(decay.Bac_all_geodist.exp.sne$pseudo.r.squared,3),
             ", p-value = ",round(decay.Bac_all_geodist.exp.sne$p.value,3)), side = 3, line = 0.5, outer = F,adj = c(0,0), cex=0.7) # side 1=bottom, 2=left, 3=top, 4=right

plot.decay.pretty(decay.Fun_all_geodist.exp.sne, col="#f18f01", add=F, 
           xlim = c(0,1600),ylim = c(0,1),las=1, lty=1,lwd=5,
           col.line="#B76E01",xaxp = c(0,1500,3),
           ylab="",xlab="")
mtext(paste0("βsne ~ S: pseudo-R2 = ", round(decay.Fun_all_geodist.exp.sne$pseudo.r.squared,3),
             ", p-value = ",round(decay.Fun_all_geodist.exp.sne$p.value,3)), side = 3, line = 0.5, outer = F,adj = c(0,0), cex=0.7) # side 1=bottom, 2=left, 3=top, 4=right

```

(ref:DD-BF-all-fig-caption) Spatial distance decay models of pairwise bacterial (blue) and fungal (orange) community dissimilarities, across geographic distance for all sites and samples. Models were fit using negative exponential to describe decay of community similarity with spatial distance (in km). The first model parameter ('a') is the intercept, the second parameter ('b') is the slope, and the $pseudo-R^2$ is the proportion of the variation in the dependent variable that the model accounts for. A) Bac βsor ~ S: $pseudo-R^2$ = `r round(decay.Bac_all_geodist.exp.sor$pseudo.r.squared,3)`, a = `r round(decay.Bac_all_geodist.exp.sor$first.parameter,3)`, b = `r formatC(decay.Bac_all_geodist.exp.sor$second.parameter,digits=3, format="e")`, $p$-value = `r decay.Bac_all_geodist.exp.sor$p.value`. B) Fungal βsor ~ S: $pseudo-R^2$ = `r round(decay.Fun_all_geodist.exp.sor$pseudo.r.squared,3)`, a = `r round(decay.Fun_all_geodist.exp.sor$first.parameter,3)`, b = `r formatC(decay.Fun_all_geodist.exp.sor$second.parameter,digits=3, format="e")`, $p$-value = `r decay.Fun_all_geodist.exp.sor$p.value`. Both model parameters differed between domains (βsor ~ S assessed via block-site bootstrap; 'a' $p$-value = `r formatC(zdepDDBF_All_sor[1,2],digits=3, format="e")`, 'b' $p$-value = `r formatC(zdepDDBF_All_sor[2,2],digits=3, format="e")`). 
...
```{r table-DD-BF-all, echo=FALSE,eval=TRUE}
kbl(
as.data.frame(
  t(data.frame("βsor" = c(round(decay.Bac_all_geodist.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_all_geodist.exp.sor$first.parameter,3),
  formatC(decay.Bac_all_geodist.exp.sor$second.parameter,digits=3, format="e"),
  decay.Bac_all_geodist.exp.sor$p.value,
  round(decay.Fun_all_geodist.exp.sor$pseudo.r.squared,3),
  round(decay.Fun_all_geodist.exp.sor$first.parameter,3),
  formatC(decay.Fun_all_geodist.exp.sor$second.parameter,digits=3, format="e"),
  decay.Fun_all_geodist.exp.sor$p.value,
...
#sim
  t(data.frame("βsim" = c(round(decay.Bac_all_geodist.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_all_geodist.exp.sim$first.parameter,3),
  formatC(decay.Bac_all_geodist.exp.sim$second.parameter,digits=3, format="e"),
  decay.Bac_all_geodist.exp.sim$p.value,
  round(decay.Fun_all_geodist.exp.sim$pseudo.r.squared,3),
  round(decay.Fun_all_geodist.exp.sim$first.parameter,3),
  formatC(decay.Fun_all_geodist.exp.sim$second.parameter,digits=3, format="e"),
  decay.Fun_all_geodist.exp.sim$p.value,
  formatC(zdepDDBF_All_sim[1,2],digits=2, format="e"),
  formatC(zdepDDBF_All_sim[2,2],digits=2, format="e")
  ),stringsAsFactors =T))
) %>% rbind(
#sne
  t(data.frame("βnes" = c(round(decay.Bac_all_geodist.exp.sne$pseudo.r.squared,3),
  round(decay.Bac_all_geodist.exp.sne$first.parameter,3),
  formatC(decay.Bac_all_geodist.exp.sne$second.parameter,digits=3, format="e"),
  decay.Bac_all_geodist.exp.sne$p.value,
  round(decay.Fun_all_geodist.exp.sne$pseudo.r.squared,3),
  round(decay.Fun_all_geodist.exp.sne$first.parameter,3),
  formatC(decay.Fun_all_geodist.exp.sne$second.parameter,digits=3, format="e"),
  decay.Fun_all_geodist.exp.sne$p.value,
...
) %>% add_header_above(c(" " = 1,"Bacteria" = 4, "Fungi" = 4, "Between-Kingdom Bootstrap" = 2)) %>% pack_rows("Spatial", 1, 3)  %>% 
  # pack_rows("Environmental", 4, 5)  %>% 
  kable_styling()
```
...
```{r calc-Bac-clus-sor-geo, warning=T,eval=TRUE,cache=T}
# B1
...
```{r calc-Bac-clus-sim-geo, warning=T,eval=TRUE,cache=T}
# B1
...
```{r table-Bac-clus-sor-geo, echo=FALSE,eval=TRUE}
# make df ----
#sor
Bac_sor_clusters_df1<-as.data.frame(
#sor
  t(data.frame("B1" = c(round(decay.Bac_B1.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_B1.exp.sor$first.parameter,3),
  formatC(decay.Bac_B1.exp.sor$second.parameter,digits=2, format="e"),
  decay.Bac_B1.exp.sor$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B1_geodist"]]),0),
  betaname="βsor"),stringsAsFactors =T))#,check.names=F
) %>% rbind(
  t(data.frame("B2" = c(round(decay.Bac_B2.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_B2.exp.sor$first.parameter,3),
  formatC(decay.Bac_B2.exp.sor$second.parameter,digits=2, format="e"),
  decay.Bac_B2.exp.sor$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B2_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B3" = c(round(decay.Bac_B3.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_B3.exp.sor$first.parameter,3),
  formatC(decay.Bac_B3.exp.sor$second.parameter,digits=2, format="e"),
  decay.Bac_B3.exp.sor$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B3_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B4" = c(round(decay.Bac_B4.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_B4.exp.sor$first.parameter,3),
  formatC(decay.Bac_B4.exp.sor$second.parameter,digits=2, format="e"),
  decay.Bac_B4.exp.sor$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B4_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B5" = c(round(decay.Bac_B5.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_B5.exp.sor$first.parameter,3),
  formatC(decay.Bac_B5.exp.sor$second.parameter,digits=2, format="e"),
  decay.Bac_B5.exp.sor$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B5_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
# ) %>% rbind(
#   t(data.frame("B6" = c(round(decay.Bac_B6.exp.sor$pseudo.r.squared,3),
#   round(decay.Bac_B6.exp.sor$first.parameter,3),
#   formatC(decay.Bac_B6.exp.sor$second.parameter,digits=2, format="e"),
#   decay.Bac_B6.exp.sor$p.value,
#   round(max(env_dist_matrices[["Bac_sor_clusters"]][["B6_geodist"]]),0)
#   ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B7" = c(round(decay.Bac_B7.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_B7.exp.sor$first.parameter,3),
  formatC(decay.Bac_B7.exp.sor$second.parameter,digits=2, format="e"),
  decay.Bac_B7.exp.sor$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B7_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B8" = c(round(decay.Bac_B8.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_B8.exp.sor$first.parameter,3),
  formatC(decay.Bac_B8.exp.sor$second.parameter,digits=2, format="e"),
  decay.Bac_B8.exp.sor$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B8_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B9" = c(round(decay.Bac_B9.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_B9.exp.sor$first.parameter,3),
  formatC(decay.Bac_B9.exp.sor$second.parameter,digits=2, format="e"),
  decay.Bac_B9.exp.sor$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B9_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B10" = c(round(decay.Bac_B10.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_B10.exp.sor$first.parameter,3),
  formatC(decay.Bac_B10.exp.sor$second.parameter,digits=2, format="e"),
  decay.Bac_B10.exp.sor$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B10_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B11" = c(round(decay.Bac_B11.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_B11.exp.sor$first.parameter,3),
  formatC(decay.Bac_B11.exp.sor$second.parameter,digits=2, format="e"),
  decay.Bac_B11.exp.sor$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B11_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B12" = c(round(decay.Bac_B12.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_B12.exp.sor$first.parameter,3),
  formatC(decay.Bac_B12.exp.sor$second.parameter,digits=2, format="e"),
  decay.Bac_B12.exp.sor$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B12_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B13" = c(round(decay.Bac_B13.exp.sor$pseudo.r.squared,3),
  round(decay.Bac_B13.exp.sor$first.parameter,3),
  formatC(decay.Bac_B13.exp.sor$second.parameter,digits=2, format="e"),
  decay.Bac_B13.exp.sor$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B13_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
  # ) %>% rbind(
  #   t(data.frame("B14" = c(round(decay.Bac_B14.exp.sor$pseudo.r.squared,3),
  #   round(decay.Bac_B14.exp.sor$first.parameter,3),
  #   formatC(decay.Bac_B14.exp.sor$second.parameter,digits=2, format="e"),
  #   decay.Bac_B14.exp.sor$p.value,
  #   round(max(env_dist_matrices[["Bac_sor_clusters"]][["B14_geodist"]]),0)
  #   ),stringsAsFactors =T)) 
# sim
) %>% rbind(
  t(data.frame("B1" = c(round(decay.Bac_B1.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_B1.exp.sim$first.parameter,3),
  formatC(decay.Bac_B1.exp.sim$second.parameter,digits=2, format="e"),
  decay.Bac_B1.exp.sim$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B1_geodist"]]),0),
  betaname="βsim"),stringsAsFactors =T))#,check.names=F
) %>% rbind(
  t(data.frame("B2" = c(round(decay.Bac_B2.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_B2.exp.sim$first.parameter,3),
  formatC(decay.Bac_B2.exp.sim$second.parameter,digits=2, format="e"),
  decay.Bac_B2.exp.sim$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B2_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B3" = c(round(decay.Bac_B3.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_B3.exp.sim$first.parameter,3),
  formatC(decay.Bac_B3.exp.sim$second.parameter,digits=2, format="e"),
  decay.Bac_B3.exp.sim$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B3_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B4" = c(round(decay.Bac_B4.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_B4.exp.sim$first.parameter,3),
  formatC(decay.Bac_B4.exp.sim$second.parameter,digits=2, format="e"),
  decay.Bac_B4.exp.sim$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B4_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B5" = c(round(decay.Bac_B5.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_B5.exp.sim$first.parameter,3),
  formatC(decay.Bac_B5.exp.sim$second.parameter,digits=2, format="e"),
  decay.Bac_B5.exp.sim$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B5_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B7" = c(round(decay.Bac_B7.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_B7.exp.sim$first.parameter,3),
  formatC(decay.Bac_B7.exp.sim$second.parameter,digits=2, format="e"),
  decay.Bac_B7.exp.sim$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B7_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B8" = c(round(decay.Bac_B8.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_B8.exp.sim$first.parameter,3),
  formatC(decay.Bac_B8.exp.sim$second.parameter,digits=2, format="e"),
  decay.Bac_B8.exp.sim$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B8_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B9" = c(round(decay.Bac_B9.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_B9.exp.sim$first.parameter,3),
  formatC(decay.Bac_B9.exp.sim$second.parameter,digits=2, format="e"),
  decay.Bac_B9.exp.sim$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B9_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B10" = c(round(decay.Bac_B10.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_B10.exp.sim$first.parameter,3),
  formatC(decay.Bac_B10.exp.sim$second.parameter,digits=2, format="e"),
  decay.Bac_B10.exp.sim$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B10_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B11" = c(round(decay.Bac_B11.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_B11.exp.sim$first.parameter,3),
  formatC(decay.Bac_B11.exp.sim$second.parameter,digits=2, format="e"),
  decay.Bac_B11.exp.sim$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B11_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B12" = c(round(decay.Bac_B12.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_B12.exp.sim$first.parameter,3),
  formatC(decay.Bac_B12.exp.sim$second.parameter,digits=2, format="e"),
  decay.Bac_B12.exp.sim$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B12_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("B13" = c(round(decay.Bac_B13.exp.sim$pseudo.r.squared,3),
  round(decay.Bac_B13.exp.sim$first.parameter,3),
  formatC(decay.Bac_B13.exp.sim$second.parameter,digits=2, format="e"),
  decay.Bac_B13.exp.sim$p.value,
  round(max(env_dist_matrices[["Bac_sor_clusters"]][["B13_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% cbind("Bacterial sub-assemblage" = c("B1","B2","B3","B4","B5","B7","B8","B9","B10","B11","B12","B13","B1","B2","B3","B4","B5","B7","B8","B9","B10","B11","B12","B13")
)
# ENDmake df ----

colnames(Bac_sor_clusters_df1) <-c("pseudo-R2","intercept","slope","p-value",
                 "max pairwise distance (km)","betaname","Bacterial sub-assemblage")

Bac_sor_clusters_df <- cbind("Bacterial sub-assemblage"=Bac_sor_clusters_df1[,7],Bac_sor_clusters_df1[,1:6])

#%>% 
#%>% cbind("Fungal sub-assemblage" = c("F1","F3","F4","F5","F6","F7","F8","F9","F10") ) %>% 
  kbl(Bac_sor_clusters_df[,1:6],
      # col.names=c("pseudo-R2","intercept","slope","p-value",
      #            "max pairwise distance (km)","betaname","Fungal sub-assemblage"),
      align=c("c"),row.names = F) %>%
  # dplyr::select(-betaname) %>%
  add_header_above(c(" " = 1,"Bacterial Decay parameters" = 4, "Distance Spanned" = 1)) %>%
  pack_rows("βsor", 1,12) %>%
  pack_rows("βsim", 13,24) %>%
  # column_spec(2, align = "c") %>%
  kable_styling()
...
```{r calc-Fun-clus-sor-geo, warning=T,eval=TRUE,cache=T}
# F1
...
```{r calc-Fun-clus-sim-geo, warning=T,eval=TRUE,cache=T,echo=FALSE}
# F1
...
```{r plot-Fun-clus-sor-sim-geo, warning=T,eval=TRUE,cache=F,echo=F, fig.dim=c(7,4),fig.dpi=250}
par(mfrow = c(1, 2),#c(nr, nc) 
    mar = c(2, 2, 2.5, 2),# c(bottom, left, top, right) defaults mar  c(5.1, 4.1, 4.1, 2.1)
    oma = (c(3, 0, 2, 0) + 0.1))
...
```{r table-Fun-clus-sor-geo, echo=FALSE,eval=TRUE}
# make df ----
#sor
Fun_sor_clusters_df1<-as.data.frame(
  t(data.frame("F1" = c(round(decay.Fun_F1.exp.sor$pseudo.r.squared,3),
  round(decay.Fun_F1.exp.sor$first.parameter,3),
  formatC(decay.Fun_F1.exp.sor$second.parameter,digits=2, format="e"),
  decay.Fun_F1.exp.sor$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F1_geodist"]]),0),
  betaname="βsor"),stringsAsFactors =T)),check.names=F
) %>% rbind(
  t(data.frame("F3" = c(round(decay.Fun_F3.exp.sor$pseudo.r.squared,3),
  round(decay.Fun_F3.exp.sor$first.parameter,3),
  formatC(decay.Fun_F3.exp.sor$second.parameter,digits=2, format="e"),
  decay.Fun_F3.exp.sor$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F3_geodist"]]),2)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F4" = c(round(decay.Fun_F4.exp.sor$pseudo.r.squared,3),
  round(decay.Fun_F4.exp.sor$first.parameter,3),
  formatC(decay.Fun_F4.exp.sor$second.parameter,digits=2, format="e"),
  decay.Fun_F4.exp.sor$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F4_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F5" = c(round(decay.Fun_F5.exp.sor$pseudo.r.squared,3),
  round(decay.Fun_F5.exp.sor$first.parameter,3),
  formatC(decay.Fun_F5.exp.sor$second.parameter,digits=2, format="e"),
  decay.Fun_F5.exp.sor$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F5_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F6" = c(round(decay.Fun_F6.exp.sor$pseudo.r.squared,3),
  round(decay.Fun_F6.exp.sor$first.parameter,3),
  formatC(decay.Fun_F6.exp.sor$second.parameter,digits=2, format="e"),
  decay.Fun_F6.exp.sor$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F6_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F7" = c(round(decay.Fun_F7.exp.sor$pseudo.r.squared,3),
  round(decay.Fun_F7.exp.sor$first.parameter,3),
  formatC(decay.Fun_F7.exp.sor$second.parameter,digits=2, format="e"),
  decay.Fun_F7.exp.sor$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F7_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F8" = c(round(decay.Fun_F8.exp.sor$pseudo.r.squared,3),
  round(decay.Fun_F8.exp.sor$first.parameter,3),
  formatC(decay.Fun_F8.exp.sor$second.parameter,digits=2, format="e"),
  decay.Fun_F8.exp.sor$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F8_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F9" = c(round(decay.Fun_F9.exp.sor$pseudo.r.squared,3),
  round(decay.Fun_F9.exp.sor$first.parameter,3),
  formatC(decay.Fun_F9.exp.sor$second.parameter,digits=2, format="e"),
  decay.Fun_F9.exp.sor$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F9_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F10" = c(round(decay.Fun_F10.exp.sor$pseudo.r.squared,3),
  round(decay.Fun_F10.exp.sor$first.parameter,3),
  formatC(decay.Fun_F10.exp.sor$second.parameter,digits=2, format="e"),
  decay.Fun_F10.exp.sor$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F10_geodist"]]),0)
  ,betaname="βsor"),stringsAsFactors =T))
) %>% rbind(
  t(data.frame("F1" = c(round(decay.Fun_F1.exp.sim$pseudo.r.squared,3),
  round(decay.Fun_F1.exp.sim$first.parameter,3),
  formatC(decay.Fun_F1.exp.sim$second.parameter,digits=2, format="e"),
  decay.Fun_F1.exp.sim$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F1_geodist"]]),0),
  betaname="βsim"),stringsAsFactors =T))
  # ,"Fungal sub-assemblage" = c("F1")
) %>% rbind(
  t(data.frame("F3" = c(round(decay.Fun_F3.exp.sim$pseudo.r.squared,3),
  round(decay.Fun_F3.exp.sim$first.parameter,3),
  formatC(decay.Fun_F3.exp.sim$second.parameter,digits=2, format="e"),
  decay.Fun_F3.exp.sim$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F3_geodist"]]),2)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F4" = c(round(decay.Fun_F4.exp.sim$pseudo.r.squared,3),
  round(decay.Fun_F4.exp.sim$first.parameter,3),
  formatC(decay.Fun_F4.exp.sim$second.parameter,digits=2, format="e"),
  decay.Fun_F4.exp.sim$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F4_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F5" = c(round(decay.Fun_F5.exp.sim$pseudo.r.squared,3),
  round(decay.Fun_F5.exp.sim$first.parameter,3),
  formatC(decay.Fun_F5.exp.sim$second.parameter,digits=2, format="e"),
  decay.Fun_F5.exp.sim$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F5_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F6" = c(round(decay.Fun_F6.exp.sim$pseudo.r.squared,3),
  round(decay.Fun_F6.exp.sim$first.parameter,3),
  formatC(decay.Fun_F6.exp.sim$second.parameter,digits=2, format="e"),
  decay.Fun_F6.exp.sim$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F6_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F7" = c(round(decay.Fun_F7.exp.sim$pseudo.r.squared,3),
  round(decay.Fun_F7.exp.sim$first.parameter,3),
  formatC(decay.Fun_F7.exp.sim$second.parameter,digits=2, format="e"),
  decay.Fun_F7.exp.sim$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F7_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F8" = c(round(decay.Fun_F8.exp.sim$pseudo.r.squared,3),
  round(decay.Fun_F8.exp.sim$first.parameter,3),
  formatC(decay.Fun_F8.exp.sim$second.parameter,digits=2, format="e"),
  decay.Fun_F8.exp.sim$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F8_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F9" = c(round(decay.Fun_F9.exp.sim$pseudo.r.squared,3),
  round(decay.Fun_F9.exp.sim$first.parameter,3),
  formatC(decay.Fun_F9.exp.sim$second.parameter,digits=2, format="e"),
  decay.Fun_F9.exp.sim$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F9_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T)) 
) %>% rbind(
  t(data.frame("F10" = c(round(decay.Fun_F10.exp.sim$pseudo.r.squared,3),
  round(decay.Fun_F10.exp.sim$first.parameter,3),
  formatC(decay.Fun_F10.exp.sim$second.parameter,digits=2, format="e"),
  decay.Fun_F10.exp.sim$p.value,
  round(max(env_dist_matrices[["Fun_sor_clusters"]][["F10_geodist"]]),0)
  ,betaname="βsim"),stringsAsFactors =T))
) %>% cbind("Fungal sub-assemblage" = c("F1","F3","F4","F5","F6","F7","F8","F9","F10",
...
colnames(Fun_sor_clusters_df1) <-c("pseudo-R2","intercept","slope","p-value",
                 "max pairwise distance (km)","betaname","Fungal sub-assemblage")

Fun_sor_clusters_df <- cbind("Fungal sub-assemblage"=Fun_sor_clusters_df1[,7],Fun_sor_clusters_df1[,1:6])

#%>% 
#%>% cbind("Fungal sub-assemblage" = c("F1","F3","F4","F5","F6","F7","F8","F9","F10") ) %>% 
  kbl(Fun_sor_clusters_df[,1:6],
      # col.names=c("pseudo-R2","intercept","slope","p-value",
      #            "max pairwise distance (km)","betaname","Fungal sub-assemblage"),
      align=c("c"),row.names = F) %>%
  # dplyr::select(-betaname) %>%
  add_header_above(c(" " = 1,"Fungal Decay parameters" = 4, "Distance Spanned" = 1)) %>%
  pack_rows("βsor", 1,9) %>%
  pack_rows("βsim", 10,10) %>%
  # column_spec(2, align = "c") %>%
  kable_styling()
```
...
```{r plot-Fun-clus2-sor-sim-geo, warning=T,eval=TRUE,cache=F,echo=FALSE,fig.dim=c(9,4),fig.dpi=250}
...
plot.decay.pretty(decay.Fun_sor_clus2nonF1.exp.sor, col="#7FBC41B3", add=T, main="Total Dissimilarity (βsor)\nFungi: non-F1", cex.main=0.9,
           xlim = c(0,1600),ylim = c(0,1),las=1, lty=1,lwd=5,
           col.line="#276419",xaxp = c(0,1500,3),
           ylab="",xlab="")
mtext((paste("F1 - ",round(decay.Fun_sor_clus2F1.exp.sor$pseudo.r.squared,3),
             " (",round(decay.Fun_sor_clus2F1.exp.sor$p.value,3),")",
             sep = "")),side=1,line=-3,adj=0.9,outer = F,padj = 0.1,
      col=col_n10[1])
mtext((paste("non-F1 - ",round(decay.Fun_sor_clus2nonF1.exp.sor$pseudo.r.squared,3),
             " (",round(decay.Fun_sor_clus2nonF1.exp.sor$p.value,3),")",
             sep = "")),side=1,line=-1.5,adj=0.9,outer = F,padj = 0.1, 
      col="#7FBC41")
mtext((paste("pseudo-R2 (p-value)",sep = "")),side=1,line=-4,
      col="black", cex=0.7,outer=F, adj= 0.95, padj = 0.15)
###########################
...
plot.decay.pretty(decay.Fun_sor_clus2nonF1.exp.sim, col="#7FBC41B3", add=T, main="Nestedness-Resultant (βsim)\nFungi: non-F1", cex.main=0.9,
           xlim = c(0,1600),ylim = c(0,1),las=1, lty=1,lwd=5,
           col.line="#276419",xaxp = c(0,1500,3),
           ylab="",xlab="")
mtext((paste("F1 - ",round(decay.Fun_sor_clus2F1.exp.sim$pseudo.r.squared,3),
             " (",round(decay.Fun_sor_clus2F1.exp.sim$p.value,3),")",
             sep = "")),side=1,line=-3,outer=F,adj=0.9,padj = 0.1,
      col=col_n10[1])
mtext((paste("non-F1 - ",round(decay.Fun_sor_clus2nonF1.exp.sim$pseudo.r.squared,3),
             " (",round(decay.Fun_sor_clus2nonF1.exp.sim$p.value,3),")",
             sep = "")),side=1,line=-1.5,outer=F,adj=0.9,padj = 0.1,
      col="#7FBC41")
mtext((paste("pseudo-R2 (p-value)",sep = "")),side=1,line=-4,
      col="black", cex=0.7,outer = F,adj=0.95,padj = 0.15)
###########################
...
# sne
#########
plot.decay.pretty(decay.Fun_sor_clus2F1.exp.sne, col=paste(col_n10[1],"3D",sep = ""), add=F, main="Nestedness-Resultant Dissimilarity (βnes)\nFungi",cex.main=0.9,
           xlim = c(0,1600),ylim = c(0,0.35),las=1, lty=1,lwd=5,
           col.line=col_n10[1],xaxp = c(0,1500,3),
           ylab="",xlab="")
mtext("\nDistance between Communities (in km)", side = 1, line = 1, outer = TRUE) # side 1=bottom, 2=left, 3=top, 4=right

plot.decay.pretty(decay.Fun_sor_clus2nonF1.exp.sne, col="#7FBC4117", add=T, main="Total Dissimilarity (βnes)\nFungi: non-F1", cex.main=0.9,
           xlim = c(0,1600),ylim = c(0,0.35),las=1, lty=1,lwd=5,
           col.line="#276419",xaxp = c(0,1500,3),
           ylab="",xlab="")
mtext((paste("F1 - ",round(decay.Fun_sor_clus2F1.exp.sne$pseudo.r.squared,3),
             " (",round(decay.Fun_sor_clus2F1.exp.sne$p.value,3),")",
             sep = "")),side=3,line=-3.5,outer=F, adj= 0.9 ,padj = 0.1,
      col=col_n10[1])
mtext((paste("non-F1 - ",round(decay.Fun_sor_clus2nonF1.exp.sne$pseudo.r.squared,3),
             " (",round(decay.Fun_sor_clus2nonF1.exp.sne$p.value,3),")",
             sep = "")),side=3,line=-2.3,outer=F, adj= 0.9 ,padj = 0.1,
      col="#7FBC41")
mtext((paste("pseudo-R2 (p-value)",sep = "")),side=3,line=-1.05,
      col="black", cex=0.7,outer=F, adj= 0.95 ,padj = 0.05)
###########################
...
```{r table-Fun-clus2-sor-geo, echo=FALSE,eval=TRUE}
# make df ----

decay.Fun_sor_clus2F1.exp.sor
decay.Fun_sor_clus2nonF1.exp.sor
#sor
Fun_sor_clus2_df1<-as.data.frame(
  t(data.frame("F1" = c(round(decay.Fun_sor_clus2F1.exp.sor$pseudo.r.squared,3),
  round(decay.Fun_sor_clus2F1.exp.sor$first.parameter,3),
  formatC(decay.Fun_sor_clus2F1.exp.sor$second.parameter,digits=2, format="e"),
  decay.Fun_sor_clus2F1.exp.sor$p.value,
  round(max(env_dist_matrices[["Fun_sor_clus2"]][["F1_geodist"]]),0),
  betaname="βsor"),stringsAsFactors =T)),check.names=F
) %>% rbind(
  t(data.frame("non-F1" = c(round(decay.Fun_sor_clus2nonF1.exp.sor$pseudo.r.squared,3),
  round(decay.Fun_sor_clus2nonF1.exp.sor$first.parameter,3),
  formatC(decay.Fun_sor_clus2nonF1.exp.sor$second.parameter,digits=2, format="e"),
  decay.Fun_sor_clus2nonF1.exp.sor$p.value,
  round(max(env_dist_matrices[["Fun_sor_clus2"]][["non-F1_geodist"]]),2)
  ,betaname="βsor"),stringsAsFactors =T)) 

  ) %>% rbind( #sim
  t(data.frame("F1" = c(round(decay.Fun_sor_clus2F1.exp.sim$pseudo.r.squared,3),
  round(decay.Fun_sor_clus2F1.exp.sim$first.parameter,3),
  formatC(decay.Fun_sor_clus2F1.exp.sim$second.parameter,digits=2, format="e"),
  decay.Fun_sor_clus2F1.exp.sim$p.value,
  round(max(env_dist_matrices[["Fun_sor_clus2"]][["F1_geodist"]]),0),
  betaname="βsim"),stringsAsFactors =T))
  # ,"Fungal sub-assemblage" = c("F1")
) %>% rbind(
  t(data.frame("non-F1" = c(round(decay.Fun_sor_clus2nonF1.exp.sim$pseudo.r.squared,3),
  round(decay.Fun_sor_clus2nonF1.exp.sim$first.parameter,3),
  formatC(decay.Fun_sor_clus2nonF1.exp.sim$second.parameter,digits=2, format="e"),
  decay.Fun_sor_clus2nonF1.exp.sim$p.value,
  round(max(env_dist_matrices[["Fun_sor_clus2"]][["non-F1_geodist"]]),2)
  ,betaname="βsim"),stringsAsFactors =T)) 

  ) %>% rbind( #sne
  t(data.frame("F1" = c(round(decay.Fun_sor_clus2F1.exp.sne$pseudo.r.squared,3),
  round(decay.Fun_sor_clus2F1.exp.sne$first.parameter,3),
  formatC(decay.Fun_sor_clus2F1.exp.sne$second.parameter,digits=2, format="e"),
  decay.Fun_sor_clus2F1.exp.sne$p.value,
  round(max(env_dist_matrices[["Fun_sor_clus2"]][["F1_geodist"]]),0),
  betaname="βsne"),stringsAsFactors =T))
  # ,"Fungal sub-assemblage" = c("F1")
) %>% rbind(
  t(data.frame("non-F1" = c(round(decay.Fun_sor_clus2nonF1.exp.sne$pseudo.r.squared,3),
  round(decay.Fun_sor_clus2nonF1.exp.sne$first.parameter,3),
  formatC(decay.Fun_sor_clus2nonF1.exp.sne$second.parameter,digits=2, format="e"),
  decay.Fun_sor_clus2nonF1.exp.sne$p.value,
  round(max(env_dist_matrices[["Fun_sor_clus2"]][["non-F1_geodist"]]),2)
  ,betaname="βsne"),stringsAsFactors =T)) 
  
  ) %>% cbind("Fungal sub-assemblage" = c("F1","non-F1","F1","non-F1","F1","non-F1")
)
# ENDmake df ----

colnames(Fun_sor_clus2_df1) <-c("pseudo-R2","intercept","slope","p-value",
                 "max pairwise distance (km)","betaname","Fungal sub-assemblage")

Fun_sor_clus2_df <- cbind("Fungal sub-assemblage"=Fun_sor_clus2_df1[,7],Fun_sor_clus2_df1[,1:6])

#%>% 
#%>% cbind("Fungal sub-assemblage" = c("F1","F3","F4","F5","F6","F7","F8","F9","F10") ) %>% 
  kbl(Fun_sor_clus2_df[,1:6],
      # col.names=c("pseudo-R2","intercept","slope","p-value",
      #            "max pairwise distance (km)","betaname","Fungal sub-assemblage"),
      align=c("c"),row.names = F) %>%
  # dplyr::select(-betaname) %>%
