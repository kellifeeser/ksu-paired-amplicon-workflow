...
<div class="figure">
<img src="F1_vs_nonF1_v2_files/figure-html/fig-spatial-dist-1.png" alt="Figure 1. Q–Q plots and distribution of spatial distances within F1 and non-F1 groups."  />
...
median_p <- pvalue(median_test_res)
...
comparison_row <- data.frame(
  ...
  SD = NA,
  Median = glue::glue("{ifelse(median_p < 0.05, 'different', 'not different')} (p = {signif(median_p, 3)})"),
  Min = NA,
  Max = NA,
  Variance = glue::glue("{ifelse(var_p < 0.05, 'different', 'not different')} (p = {signif(var_p, 3)})"),
  Skewness = glue::glue("{skew_differs} (CI F1: {skew_ci_f1[1]}–{skew_ci_f1[2]}, non-F1: {skew_ci_nf1[1]}–{skew_ci_nf1[2]})"),
  Kurtosis = glue::glue("{kurt_differs} (CI F1: {kurt_ci_f1[1]}–{kurt_ci_f1[2]}, non-F1: {kurt_ci_nf1[1]}–{kurt_ci_nf1[2]})"),
  IQR = NA,
  Range = NA,
  CV = NA,
  Cohens_d = round(cohen_d, 2),
  Log_Response_Ratio = round(log_ratio, 2),
  Cohens_d_CI = glue::glue("{ci_d[1]}–{ci_d[2]}"),
  Log_Response_CI = glue::glue("{ci_lr[1]}–{ci_lr[2]}")
)

# Final table
final_stats <- bind_rows(summary_stats, comparison_row)
...
<caption style="font-size: initial !important;">(\#tab:fig1-summary-table)(\#tab:fig1-summary-table)Table 1. Summary statistics for spatial distances within F1 and non-F1 groups. 
 ...
 <thead>
  <tr>
   ...
   <th style="text-align:right;"> Log_Response_Ratio </th>
...
<tbody>
  <tr>
   ...
   <td style="text-align:left;"> 16653.00 </td>
   <td style="text-align:left;"> 740.38 </td>
   <td style="text-align:left;"> 442.94 </td>
   <td style="text-align:left;"> 709.76 </td>
   <td style="text-align:left;"> 0.00 </td>
   <td style="text-align:left;"> 1560.05 </td>
   <td style="text-align:left;"> 196199.63 </td>
   <td style="text-align:left;"> -0.32 </td>
   <td style="text-align:left;"> -1.08 </td>
   <td style="text-align:right;"> 752.99 </td>
   <td style="text-align:right;"> 1560.05 </td>
  ...
  <tr>
   ...
   <td style="text-align:left;"> 45150.00 </td>
   <td style="text-align:left;"> 640.34 </td>
   <td style="text-align:left;"> 380.14 </td>
   <td style="text-align:left;"> 646.18 </td>
   <td style="text-align:left;"> 0.00 </td>
   <td style="text-align:left;"> 1444.53 </td>
   <td style="text-align:left;"> 144509.58 </td>
   <td style="text-align:left;"> 0.00 </td>
   <td style="text-align:left;"> -1.00 </td>
   <td style="text-align:right;"> 604.60 </td>
   <td style="text-align:right;"> 1444.53 </td>
  ...
  <tr>
   ...
   <td style="text-align:left;"> different (CI F1: -0.34–-0.3, non-F1: -0.01–0.02) </td>
...
```
## Warning in describe_cohen_d(vec1, vec2): Too few valid bootstrap samples to
## compute CI.
```
...
![](F1_vs_nonF1_v2_files/figure-html/fig-map-hulls-1.png)<!-- -->
