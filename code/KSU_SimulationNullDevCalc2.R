...
#           file="../processed_data/BetaNullDeviation/Bac.SCSC_BnullDev_abund_bysample.csv")
# write.csv(all_summary, row.names = F,
#           file="../processed_data/BetaNullDeviation/Bac.SCSC_BnullDev_abund_summary.csv")
write.csv(output.by.sample.df,
          file="../processed_data/BetaNullDeviation/Fun.SCSC_BnullDev_abund_bysample.csv")
write.csv(all_summary, row.names = F,
          file="../processed_data/BetaNullDeviation/Fun.SCSC_BnullDev_abund_summary.csv")



# write.csv(output.by.sample.df,
#           file="../processed_data/BetaNullDeviation/Bac.ANGE_BnullDev_abund_bysample.csv")
# write.csv(all_summary, row.names = F,
#           file="../processed_data/BetaNullDeviation/Bac.ANGE_BnullDev_abund_summary.csv")
# write.csv(output.by.sample.df,
#           file="../processed_data/BetaNullDeviation/Fun.ANGE_BnullDev_abund_bysample.csv")
# write.csv(all_summary, row.names = F,
#           file="../processed_data/BetaNullDeviation/Fun.ANGE_BnullDev_abund_summary.csv")


# write.csv(output.by.sample.df,
#           file="../processed_data/BetaNullDeviation/Bac.BUDA_BnullDev_abund_bysample.csv")
# write.csv(all_summary, row.names = F,
#           file="../processed_data/BetaNullDeviation/Bac.BUDA_BnullDev_abund_summary.csv")
# write.csv(output.by.sample.df,
#           file="../processed_data/BetaNullDeviation/Fun.BUDA_BnullDev_abund_bysample.csv")
# write.csv(all_summary, row.names = F,
#           file="../processed_data/BetaNullDeviation/Fun.BUDA_BnullDev_abund_summary.csv")

# write.csv(output.by.sample.df,
#           file="../processed_data/BetaNullDeviation/Fun.BOER_BnullDev_abund_bysample.csv")
# write.csv(all_summary, row.names = F,
#           file="../processed_data/BetaNullDeviation/Fun.BOER_BnullDev_abund_summary.csv")
# write.csv(output.by.sample.df,
#           file="../processed_data/BetaNullDeviation/Bac.BOER_BnullDev_abund_bysample.csv")
# write.csv(all_summary, row.names = F,
#           file="../processed_data/BetaNullDeviation/Bac.BOER_BnullDev_abund_summary.csv")
