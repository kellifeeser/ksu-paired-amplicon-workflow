...
plot.decay.pretty(decay.Fun_F1.exp.sor2, col=paste(col_n10[1],"cc",sep = ""), add=F, main="Total Dissimilarity (βsor)", sub="Fungi",
           xlim = c(0,1600),ylim = c(0,1),las=1, lty=1,lwd=5,
